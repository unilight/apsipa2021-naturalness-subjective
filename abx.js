...
function start_experiment(){
    ...
    // read filepath
    var method0_list = wav_dir + "set" + set_num + "/dtw_mcc.list";
    var method1_list = wav_dir + "set" + set_num + "/liplandmark.list";
    var method2_list = wav_dir + "set" + set_num + "/pixelmse.list";
